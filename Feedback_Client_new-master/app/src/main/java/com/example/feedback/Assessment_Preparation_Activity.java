...
public class Assessment_Preparation_Activity extends Activity implements AdapterView.OnItemClickListener {
            ...
            public void handleMessage(Message msg)
            {
                switch (msg.what)
                {
                    ...
                    case 207: //邀请assessor成功
                        ...
                        Toast.makeText(Assessment_Preparation_Activity.this,"invite success", Toast.LENGTH_LONG).show();
                        break;
    ...
    //refresh the layout
    public void refresh(){
        String password = AllFunctions.getObject().getPassword();
        String username = AllFunctions.getObject().getMyEmail();
        AllFunctions.getObject().login(username, password);
